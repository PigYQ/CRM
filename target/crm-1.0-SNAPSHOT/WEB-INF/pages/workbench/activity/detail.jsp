...
<script type="text/javascript">
	...
	$(function(){
			...
			$.ajax({
				...
				success:function (data){
					if (data.code==="1"){
						...
						//这里不能用data，因为data里createBy存的是创建者id不是名字
						htmlstr+="<img title=\"${sessionScope.user.name}\" src=\"image/use;r-thumbnail.png\" style=\"width: 30px; height:30px;\">";
						htmlstr+="<div style=\"position: relative; top: -40px; left: 40px;\" >";
						htmlstr+="<h5>"+data.obj.noteContent+"</h5>";
						htmlstr+="<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\"> "+data.obj.createTime+" 由${sessionScope.user.name}创建</small>";
		...
		//给删除按钮添加单击事件
		$(".remarkDiv").on("click","a[name='delete']",function (){
